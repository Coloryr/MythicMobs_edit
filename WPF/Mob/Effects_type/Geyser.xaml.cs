...
namespace MythicMobs_edit.WPF.Mob.Effects_type
{
    ...
    /// Geyser.xaml 的交互逻辑
    /// </summary>
    public partial class Geyser : Window
    {
        public Effects Effects { get; set; }
        public Geyser(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.Geyser))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.Geyser();
            }
            ...
            DataContext = this;
            Type_F.ItemsSource = new List<string>() { "water","lava" };
