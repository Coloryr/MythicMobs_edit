...
{
    /// <summary>
    /// ParticleRing.xaml 的交互逻辑
    /// </summary>
    public partial class ParticleRing : Window
    {
        public Effects Effects { get; set; }
        public ParticleRing(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.ParticleRing))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.ParticleRing();
            }
