...
{
    /// <summary>
    /// ParticleLine.xaml 的交互逻辑
    /// </summary>
    public partial class ParticleLine : Window
    {
        public Effects Effects { get; set; }
        public ParticleLine(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.ParticleLine))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.ParticleLine();
            }
