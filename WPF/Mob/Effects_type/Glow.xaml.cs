...
namespace MythicMobs_edit.WPF.Mob.Effects_type
{
    ...
    /// Glow.xaml 的交互逻辑
    /// </summary>
    public partial class Glow : Window
    {
        public Effects Effects { get; set; }
        public Glow(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.Glow))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.Glow();
            }
