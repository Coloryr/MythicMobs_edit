...
{
    /// <summary>
    /// ItemSpraycs.xaml 的交互逻辑
    /// </summary>
    public partial class ItemSpraycs : Window
    {
        public Effects Effects { get; set; }
        public ItemSpraycs(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.ItemSpraycs))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.ItemSpraycs();
            }
