...
{
    /// <summary>
    /// SmokeSwirl.xaml 的交互逻辑
    /// </summary>
    public partial class SmokeSwirl : Window
    {
        public Effects Effects { get; set; }
        public SmokeSwirl(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.SmokeSwirl))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.SmokeSwirl();
            }
