...
namespace MythicMobs_edit.WPF.Mob.Effects_type
{
    ...
    /// Smoke.xaml 的交互逻辑
    /// </summary>
    public partial class Smoke : Window
    {
        public Effects Effects { get; set; }
        public Smoke(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.Smoke))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.Smoke();
            }
