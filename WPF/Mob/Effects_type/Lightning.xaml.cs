...
namespace MythicMobs_edit.WPF.Mob.Effects_type
{
    ...
    public partial class Lightning : Window
    {
        ...
        public Lightning(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.Lightning))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.Lightning();
            }
