...
{
    /// <summary>
    /// ParticleTornado.xaml 的交互逻辑
    /// </summary>
    public partial class ParticleTornado : Window
    {
        public Effects Effects { get; set; }
        public ParticleTornado(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.ParticleTornado))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.ParticleTornado();
            }
