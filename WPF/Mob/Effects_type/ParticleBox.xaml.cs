...
{
    /// <summary>
    /// ParticleBox.xaml 的交互逻辑
    /// </summary>
    public partial class ParticleBox : Window
    {
        public Effects Effects { get; set; }
        public ParticleBox(Effects Effects)
        {
            InitializeComponent();
            this.Effects = Effects;
            if (!(this.Effects.Option is Obj_save.Mob.Effects_type.ParticleBox))
            {
                this.Effects.Option = new Obj_save.Mob.Effects_type.ParticleBox();
            }
