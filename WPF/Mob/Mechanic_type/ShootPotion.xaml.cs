...
{
    /// <summary>
    /// ShootPotion.xaml 的交互逻辑
    /// </summary>
    public partial class ShootPotion : Window
    {
        public Mechanic Mechanic { get; set; }
        public ShootPotion(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ShootPotion))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ShootPotion();
            }
            ...
            DataContext = this;
            Type_.ItemsSource = new List().PotionEffects;
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            List list = new List();
            Type_.SelectedItem = list.PotionEffects[random.Next(list.PotionEffects.Count)];
        }
    }
}
