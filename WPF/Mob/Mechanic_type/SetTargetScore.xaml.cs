...
{
    /// <summary>
    /// SetTargetScore.xaml 的交互逻辑
    /// </summary>
    public partial class SetTargetScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public SetTargetScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetTargetScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetTargetScore();
            }
