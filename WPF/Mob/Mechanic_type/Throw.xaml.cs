...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Throw.xaml 的交互逻辑
    /// </summary>
    public partial class Throw : Window
    {
        public Mechanic Mechanic { get; set; }
        public Throw(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Throw))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Throw();
            }
