...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// SetScore.xaml 的交互逻辑
    /// </summary>
    public partial class SetScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public SetScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetScore();
            }
