...
{
    /// <summary>
    /// ModifyGlobalScore.xaml 的交互逻辑
    /// </summary>
    public partial class ModifyGlobalScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public ModifyGlobalScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ModifyGlobalScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ModifyGlobalScore();
            }
