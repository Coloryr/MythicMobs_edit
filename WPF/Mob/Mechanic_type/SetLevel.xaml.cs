...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    public partial class SetLevel : Window
    {
        ...
        public SetLevel(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetLevel))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetLevel();
            }
