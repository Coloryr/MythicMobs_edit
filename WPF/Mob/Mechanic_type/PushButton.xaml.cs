...
{
    /// <summary>
    /// PushButton.xaml 的交互逻辑
    /// </summary>
    public partial class PushButton : Window
    {
        public Mechanic Mechanic { get; set; }
        public PushButton(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.PushButton))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.PushButton();
            }
