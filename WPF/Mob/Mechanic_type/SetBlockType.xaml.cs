...
{
    /// <summary>
    /// SetBlockType.xaml 的交互逻辑
    /// </summary>
    public partial class SetBlockType : Window
    {
        public Mechanic Mechanic { get; set; }
        public SetBlockType(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetBlockType))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetBlockType();
            }
