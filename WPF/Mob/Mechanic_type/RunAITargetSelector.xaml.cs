...
{
    /// <summary>
    /// RunAITargetSelector.xaml 的交互逻辑
    /// </summary>
    public partial class RunAITargetSelector : Window
    {
        public Mechanic Mechanic { get; set; }
        public RunAITargetSelector(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.RunAITargetSelector))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.RunAITargetSelector();
            }
            ...
            DataContext = this;
            Type_.ItemsSource = new List().AI_Target_All;
