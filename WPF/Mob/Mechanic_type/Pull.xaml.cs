...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Pull.xaml 的交互逻辑
    /// </summary>
    public partial class Pull : Window
    {
        public Mechanic Mechanic { get; set; }
        public Pull(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Pull))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Pull();
            }
