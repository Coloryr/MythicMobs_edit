...
{
    /// <summary>
    /// SetMobScore.xaml 的交互逻辑
    /// </summary>
    public partial class SetMobScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public SetMobScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetMobScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetMobScore();
            }
