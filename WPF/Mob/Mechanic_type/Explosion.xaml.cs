...
{
    /// <summary>
    /// Explosion.xaml 的交互逻辑
    /// </summary>
    public partial class Explosion : Window
    {
        public Mechanic Mechanic { get; set; }
        public Explosion(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Explosion))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Explosion();
            }
