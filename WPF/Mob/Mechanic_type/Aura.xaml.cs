...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Aura.xaml 的交互逻辑
    /// </summary>
    public partial class Aura : Window
    {
        public Mechanic Mechanic { get; set; }
        public Aura(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Aura))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Aura();
            }
