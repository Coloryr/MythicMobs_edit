...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Prison.xaml 的交互逻辑
    /// </summary>
    public partial class Prison : Window
    {
        public Mechanic Mechanic { get; set; }
        public Prison(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Prison))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Prison();
            }
