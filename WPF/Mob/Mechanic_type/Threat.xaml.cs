...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Threat.xaml 的交互逻辑
    /// </summary>
    public partial class Threat : Window
    {
        public Mechanic Mechanic { get; set; }
        public Threat(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Threat))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Threat();
            }
