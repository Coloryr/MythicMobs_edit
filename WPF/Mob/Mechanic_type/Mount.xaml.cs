...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Mount.xaml 的交互逻辑
    /// </summary>
    public partial class Mount : Window
    {
        public Mechanic Mechanic { get; set; }
        public Mount(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Mount))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Mount();
            }
