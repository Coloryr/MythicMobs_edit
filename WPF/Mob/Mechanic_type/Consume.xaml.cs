...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Consume.xaml 的交互逻辑
    /// </summary>
    public partial class Consume : Window
    {
        public Mechanic Mechanic { get; set; }
        public Consume(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Consume))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Consume();
            }
