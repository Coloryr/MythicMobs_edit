...
{
    /// <summary>
    /// SetStance.xaml 的交互逻辑
    /// </summary>
    public partial class SetStance : Window
    {
        public Mechanic Mechanic { get; set; }
        public SetStance(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.SetStance))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.SetStance();
            }
