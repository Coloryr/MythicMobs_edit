...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Skill.xaml 的交互逻辑
    /// </summary>
    public partial class Skill : Window
    {
        public Mechanic Mechanic { get; set; }
        public Skill(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Skill))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Skill();
            }
