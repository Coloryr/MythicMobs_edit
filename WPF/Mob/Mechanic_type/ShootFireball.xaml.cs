...
{
    /// <summary>
    /// ShootFireball.xaml 的交互逻辑
    /// </summary>
    public partial class ShootFireball : Window
    {
        public Mechanic Mechanic { get; set; }
        public ShootFireball(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ShootFireball))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ShootFireball();
            }
