...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Rally.xaml 的交互逻辑
    /// </summary>
    public partial class Rally : Window
    {
        public Mechanic Mechanic { get; set; }
        public Rally(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Rally))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Rally();
            }
