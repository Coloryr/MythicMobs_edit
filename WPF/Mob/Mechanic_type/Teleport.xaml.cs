...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    public partial class Teleport : Window
    {
        ...
        public Teleport(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Teleport))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Teleport();
            }
