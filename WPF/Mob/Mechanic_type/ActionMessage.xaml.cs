...
{
    /// <summary>
    /// ActionMessage.xaml 的交互逻辑
    /// </summary>
    public partial class ActionMessage : Window
    {
        public Mechanic Mechanic { get; set; }
        public ActionMessage(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ActionMessage))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ActionMessage();
            }
