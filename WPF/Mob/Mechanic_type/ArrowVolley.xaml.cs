...
{
    /// <summary>
    /// ArrowVolley.xaml 的交互逻辑
    /// </summary>
    public partial class ArrowVolley : Window
    {
        public Mechanic Mechanic { get; set; }
        public ArrowVolley(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ArrowVolley))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ArrowVolley();
            }
