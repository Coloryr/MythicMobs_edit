...
{
    /// <summary>
    /// ForcePull.xaml 的交互逻辑
    /// </summary>
    public partial class ForcePull : Window
    {
        public Mechanic Mechanic { get; set; }
        public ForcePull(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ForcePull))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ForcePull();
            }
