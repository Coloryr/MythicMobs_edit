...
{
    /// <summary>
    /// ShootSkull.xaml 的交互逻辑
    /// </summary>
    public partial class ShootSkull : Window
    {
        public Mechanic Mechanic { get; set; }
        public ShootSkull(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ShootSkull))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ShootSkull();
            }
