...
{
    /// <summary>
    /// BaseDamage.xaml 的交互逻辑
    /// </summary>
    public partial class BaseDamage : Window
    {
        public Mechanic Mechanic { get; set; }
        public BaseDamage(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.BaseDamage))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.BaseDamage();
            }
