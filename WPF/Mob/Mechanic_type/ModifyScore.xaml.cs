...
{
    /// <summary>
    /// ModifyScore.xaml 的交互逻辑
    /// </summary>
    public partial class ModifyScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public ModifyScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ModifyScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ModifyScore();
            }
