...
{
    /// <summary>
    /// RemoveTag.xaml 的交互逻辑
    /// </summary>
    public partial class RemoveTag : Window
    {
        public Mechanic Mechanic { get; set; }
        public RemoveTag(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.RemoveTag))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.RemoveTag();
            }
