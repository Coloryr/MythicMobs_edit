...
{
    /// <summary>
    /// TeleportTo.xaml 的交互逻辑
    /// </summary>
    public partial class TeleportTo : Window
    {
        public Mechanic Mechanic { get; set; }
        public TeleportTo(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.TeleportTo))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.TeleportTo();
            }
