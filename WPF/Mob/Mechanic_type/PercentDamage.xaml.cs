...
{
    /// <summary>
    /// PercentDamage.xaml 的交互逻辑
    /// </summary>
    public partial class PercentDamage : Window
    {
        public Mechanic Mechanic { get; set; }
        public PercentDamage(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.PercentDamage))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.PercentDamage();
            }
