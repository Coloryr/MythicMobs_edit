...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    public partial class Signal : Window
    {
        ...
        public Signal(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Signal))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Signal();
            }
            ...
            DataContext = this;
            Type_.ItemsSource = new List().Conditions;
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            List list = new List();
            Type_.SelectedItem = list.Conditions[random.Next(list.Conditions.Count)];
        }
    }
}
