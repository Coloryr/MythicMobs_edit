...
{
    /// <summary>
    /// Lightning.xaml 的交互逻辑
    /// </summary>
    public partial class Lightning : Window
    {
        public Mechanic Mechanic { get; set; }
        public Lightning(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Lightning))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Lightning();
            }
