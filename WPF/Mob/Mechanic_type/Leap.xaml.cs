...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Leap.xaml 的交互逻辑
    /// </summary>
    public partial class Leap : Window
    {
        public Mechanic Mechanic { get; set; }
        public Leap(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Leap))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Leap();
            }
