...
{
    /// <summary>
    /// ToggleLever.xaml 的交互逻辑
    /// </summary>
    public partial class ToggleLever : Window
    {
        public Mechanic Mechanic { get; set; }
        public ToggleLever(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ToggleLever))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ToggleLever();
            }
