...
{
    /// <summary>
    /// ModifyTargetScore.xaml 的交互逻辑
    /// </summary>
    public partial class ModifyTargetScore : Window
    {
        public Mechanic Mechanic { get; set; }
        public ModifyTargetScore(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.ModifyTargetScore))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.ModifyTargetScore();
            }
            ...
            DataContext = this;
            Type_.ItemsSource = new List().Modify;
