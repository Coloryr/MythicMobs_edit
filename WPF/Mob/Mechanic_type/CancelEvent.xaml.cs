...
{
    /// <summary>
    /// CancelEvent.xaml 的交互逻辑
    /// </summary>
    public partial class CancelEvent : Window
    {
        public Mechanic Mechanic { get; set; }
        public CancelEvent(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.CancelEvent))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.CancelEvent();
            }
