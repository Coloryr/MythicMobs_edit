...
namespace MythicMobs_edit.WPF.Mob.Mechanic_type
{
    ...
    /// Ignite.xaml 的交互逻辑
    /// </summary>
    public partial class Ignite : Window
    {
        public Mechanic Mechanic { get; set; }
        public Ignite(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.Ignite))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.Ignite();
            }
