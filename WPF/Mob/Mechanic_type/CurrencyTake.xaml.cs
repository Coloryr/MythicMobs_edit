...
{
    /// <summary>
    /// CurrencyTake.xaml 的交互逻辑
    /// </summary>
    public partial class CurrencyTake : Window
    {
        public Mechanic Mechanic { get; set; }
        public CurrencyTake(Mechanic Mechanic)
        {
            InitializeComponent();
            this.Mechanic = Mechanic;
            if (!(this.Mechanic.Option is Obj_save.Mob.Mechanic_type.CurrencyTake))
            {
                this.Mechanic.Option = new Obj_save.Mob.Mechanic_type.CurrencyTake();
            }
